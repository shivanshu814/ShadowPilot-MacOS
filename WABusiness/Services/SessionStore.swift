...
final class SessionStore {
    ...
    private func openAndMigrate() {
        ...
        let dir = support.appendingPathComponent("WA Business", isDirectory: true)

        // Carry over sessions saved under the app's former name
        let legacy = support.appendingPathComponent("ShadowPilot", isDirectory: true)
